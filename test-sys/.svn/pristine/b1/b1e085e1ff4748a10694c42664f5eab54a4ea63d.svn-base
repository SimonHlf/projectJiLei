...
<div  style="float:left;padding: 10px">
    ...
    <button type="button" onclick="fanhuiDaoPaper(${paperCreatId})" class="btn btn-success"><i class="fa fa-arrow-left"></i>返回</button>
</div>
<div style="float:left;padding: 10px">
    ...
    <div class="widget-body">
        ...
        <div class="flip-scroll col-lg-10 col-sm-10 col-xs-10"  id="menuTable">
           ...
           <c:if test="${not empty questionsList}">
           		<v:pagination page="${page}" url="PaperCreatController/toQuestList.htm?1=1&paperCreatId=${paperCreatId}"></v:pagination>	
           </c:if>
