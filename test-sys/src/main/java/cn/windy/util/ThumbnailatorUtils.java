...
public class ThumbnailatorUtils {  
 ...
 /*
    *
    ...
    public static String ImgThumb(String source,int width, int height) {  
        try {  
        	String sourcePath=source.substring(0, source.lastIndexOf("."));
        	String extName = source.substring(source.lastIndexOf("."));
        	String output=sourcePath+"small"+extName;
            Thumbnails.of(source).size(width, height).toFile(output); 
...
/*    *
    ...
    public static String ImgScale(String source, double scale) {  
        try {  
        	String sourcePath=source.substring(0, source.lastIndexOf("."));
        	String extName = source.substring(source.lastIndexOf("."));
        	String output=sourcePath+"small"+extName;
