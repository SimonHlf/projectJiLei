			...
			/* $.ajax({
			 ...
			 $.ajax({
					...
					data:{nn:nn,
						...
						cnn:cnn,
						cmm:cmm,
						danxuanIdList:danxuanIdList,
						duoxuanIdList:duoxuanIdList,
						panduanIdList:panduanIdList,
						danxuanNum:danxuanNum,
						duoxuanNum:duoxuanNum,
						panduanNum:panduanNum,
						danxuantiZong:danxuantiZong,
						duoxuantiZong:duoxuantiZong,
						panduantiZong:panduantiZong,
						paperCreatId:paperCreatId,
						line:line,
						isShow:isShow,
						examId:examId,
						danxuantiFen:danxuantiFen,
						duoxuantiFen:duoxuantiFen,
						panduantiFen:panduantiFen},
