...
<div class="widget">
    <!-- <div class="widget-header bordered-bottom bordered-themeprimary">
        ...
        <span class="widget-caption themeprimary">考生统计分析报表</span>
    </div> -->
        ...
        <div class="flip-scroll">
            ...
            <table class="table table-bordered table-striped table-condensed flip-content">
                ...
                <tr>
                    ...
                    <td></td>
                    <td></td>
                    <td><a href="${pageContext.request.contextPath}/admin/examination/examinAnalysis/detailExaminAnalysis.jsp"><!-- 查看详情 --></a> </td>
