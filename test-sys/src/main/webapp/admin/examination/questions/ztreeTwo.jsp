...
<SCRIPT>
	...
	var setting2 = {
		...
		callback : {
			onClick : function(event, treeId, treeNode) {
				$("#quesTypeList").load("QuestionsController/sonList.htm?pid=" + treeNode.id+"&name="+'${name}');
			},
		}
	};
	var nodes2 = ${nodes2};
	...
	<div id="menuTable"style="float: left; padding: 10px; width:16%;">
		<label>题库分类目录</label>
		<ul id="treeDemo2" class="ztree"></ul>
	</div>
      <div class="widget-body" id="quesTypeList" style="float:left;width:83%;padding:10px;">
