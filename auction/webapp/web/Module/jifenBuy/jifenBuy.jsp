...
<html>
	<head>
		<meta charset="UTF-8">
		<title>积分购专区</title>
		<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath }/web/Module/jifenBuy/css/jifenBuy.css"/>
	...
	<body>
		...
		<div class="categoryDiv w1100">
			...
			<dl class="clearfix">
				...
				<dd>
					<a href="javascript:void(0)" class="categroyAttr3" value="0-500">0-500积分</a>
					<a href="javascript:void(0)" class="categroyAttr3" value="500-1000">500-1000积分</a>
					<a href="javascript:void(0)" class="categroyAttr3" value="1000-1500">1000-1500积分</a>
					<a href="javascript:void(0)" class="categroyAttr3" value="1500-2000">1500-2000积分</a>
					<a href="javascript:void(0)" class="categroyAttr3" value="2000-">2000积分以上</a>
		...
		<!-- 积分list -->
		<div class="jifenList w1100">
			<ul class="clearfix" id="listProUl">
			<%-- <c:forEach var="n" items="${list}">
				<li>
					<strong class="ellip">${n.name}</strong>
					<div class="jifenProImg">
						<img src="/${n.thumbnailurl}"/>
					</div>
					<div class="botJifenList">
						<p class="useJifen">可使用积分：${n.price}</p>
						<p class="priceP">相当于省1800元</p>
						<a href="javascript:void(0)">点击购买</a>
					</div>
				</li>
			</c:forEach> --%>
			</ul>
		...
		<!-- 积分兑换区 -->
	<!-- 	<div class="jifenduihuan w1100">
			<p class="duihuanTit">积分兑换区</p>
			<div class="listDuihuan">
				<ul class="clearfix">
					<li>
						<strong class="ellip">和田羊脂白玉平安扣吊坠</strong>
						<div class="jifenProImg">
							<img src="images/jifenPro.jpg">
						</div>
						<em class="ellip">¥2500</em>
						<div class="botJifenList1">
							<p class="useJifen">换购所需积分</p>
							<p class="priceP">900积分</p>
		...
		<script type="text/javascript">
			...
			function removeAttr(options){
				...
				window.location.href="${pageContext.request.contextPath }/web/shop/jiFenBuyApi/toJifenJsp.htm?brandid="+brandid+"&price="+price+"&weight="+weight+"&weightname="+weightname+"&pricename="+pricename+"&price_order="+price_order+"&cid="+cid+"&cname="+cname+"&keywords="+keywords+"&cmd=3";
			}
			...
			function getMBList(page,pageSize){
				$.ajax({
					...
					url : "${pageContext.request.contextPath }/web/shop/jiFenBuyApi/toJifenBuyPage.htm?brandid="+brandid+"&price="+price+"&weight="+weight+"&weightname="+weightname+"&pricename="+pricename+"&price_order="+price_order+"&cid="+cid+"&cname="+cname+"&keywords="+keywords,
