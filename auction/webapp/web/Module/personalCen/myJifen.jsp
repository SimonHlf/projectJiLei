	...
	<body>
		...
		<div class="personalCenCon clearfix w1100">
			...
			<div class="rightPersonal fr">
				<strong class="rightTit"><span></span>我的积分</strong>
				<div class="rightCon">
					<div class="jifenWrap">
						<div class="myJifen">
							<span>可用积分：</span><strong class="jifenNum">${user.parentintegral}</strong>
		...
		function getMBList(page,pageSize){
			$.ajax({
				...
				url : "${pageContext.request.contextPath }/web/shop/myJiFenApi/listPage.htm",
