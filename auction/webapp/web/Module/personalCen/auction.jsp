	...
	<body>
		...
		<!-- 个人中心内容 -->
			...
			<div class="rightPersonal fr">
				<strong class="rightTit"><span></span>我的拍卖</strong>
				<div class="rightCon">
		...
		<script type="text/javascript">
			function beat(id){
				location.href='${pageContext.request.contextPath }/web/auctionOrder/beat1.htm?id='+id;
			}
			...
			function getMBList(page,pageSize){
				$.ajax({
					...
					url : "${pageContext.request.contextPath }/web/auctionOrder/myAuctionPage.htm",
