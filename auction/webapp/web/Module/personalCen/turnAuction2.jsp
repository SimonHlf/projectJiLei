...
<body>
	...
	<div class="personalCenCon clearfix w1100">
			...
			<form id="subform" action="${pageContext.request.contextPath}/web/auctionOrder/save2.htm" method="post">
				<div class="rightPersonal fr">
					<strong class="rightTit"><span></span>我的订单&gt;转竞拍</strong>
					<div class="rightCon">
						<div class="turnWrap">
							<div class="formTurn clearfix">
								...
								<div class="rightTurnInfo">
									...
									<div class="botSetJifen">
										...
										<input type="hidden" name="productId" id="productId" value="${order.id }">
