...
<html>
	...
	<head>
		...
		<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath }/webAndroid/dist/css/kind/culture/culmore.css">
		...
		<script src="${pageContext.request.contextPath }/webAndroid/js/kind/culture/culmore.js"></script>
