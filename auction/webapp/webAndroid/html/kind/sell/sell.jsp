...
<head>
	...
	<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/webAndroid/dist/css/kind/sell/sell.css">
...
<body>
		<div id="container">
			...
			<ul class="navlists">
				<li class='active'>
					<a href="sell.html">拍卖记录</a>
				</li>
				<li>
					<a href="auctionrecord.html">竞拍记录</a>
				</li>
				<li>
					<a href="mysell.html">我的拍卖</a>
				</li>
			</ul>
		</nav>
			<!----------------------------morelistss--------------------------->
			...
			<ul class="orderLists">
				<li>
						<div class="top">
							<div class="left"><span class="spanImg"><img src="../../../image/kind/logo.jpg" alt=""/></span><span class="spanTxt" >西藏锦绣</span>
								<p>2018-1-28<span>12:00</span></p>
							</div>
						</div>
						<a class="txt" href="selldetail.html">
							<div class="orderMsg">
								<div class="imgBox">
									<img src="../../../image/kind/pointImg.jpg" alt=""/>
								</div>
								<div class="centerMsg">
									<p>羊脂玉羊脂玉羊脂玉羊脂玉羊脂玉羊脂玉</p>
									<p>类型：羊脂玉200g</p>
								</div>
								<div class="rightMsg">
									<!--<p>￥2330.00</p>
						...
						<!--<div class="orderNum">
							<p>共<span>1</span>件商品&nbsp;&nbsp;合计:<span>￥2330.00</span>(含运费￥0.00)</p>
						</div>-->
						<div class="btm">
							<p>拍卖成功</p>
						</div>
