...
<html>
	...
	<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath }/webAndroid/dist/css/kind/youlgou/youlgou.css">
	...
	<script src="${pageContext.request.contextPath }/webAndroid/js/kind/youlgou/youlgou.js"></script>
		...
		<div id="container">
			...
			<div id="main">
			    <c:forEach var="n" items="${list}">
					<a class="mainBox" href="/src/html/detail/detail.html">
						<div class="mainLeft">
