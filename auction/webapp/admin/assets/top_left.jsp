...
<div class="navbar-header pull-right">
	<div class="navbar-account">
		<ul class="account-area">
			...
			<li>
				<a class="wave in dropdown-toggle" data-toggle="dropdown" title="message" href="#">
			...
			<li>
				<a class="login-area dropdown-toggle" data-toggle="dropdown">
					...
					<section>
						<h2 style="padding-right: 20px;"><span class="profile"><span>${windy_session_user.realName}</span></span></h2>
					</section>
				</a>
				<ul class="pull-right dropdown-menu dropdown-arrow dropdown-login-area">
					<li class="username"><a>${windy_session_user.realName}</a></li>
					<li class="email"><a>${windy_session_user.email}</a></li>
					<!--<li>
					...
					<!-- <li class="edit">
						<a href="profile.html" class="pull-left">个人信息</a>
			...
			<label>
				...
				<span class="text">固定导航</span>
			</label>
			<label>
				<input type="checkbox" id="checkbox_fixedsidebar">
				<span class="text">固定边栏</span>
			</label>
			<label>
