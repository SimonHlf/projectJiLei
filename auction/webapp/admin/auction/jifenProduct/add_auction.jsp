...
<div class="widget model_widget">
	<div class="widget-body">
		<div id="horizontal-form">
			<form class="form-horizontal" id="addAuction" enctype="multipart/form-data">
				<input type="hidden" name="integralId" value="${pid}">
				<div class="row">
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<textarea class="form-control" id="describes" name="describes"
							placeholder="宝贝描述" required  onblur="panduan()"></textarea>
					</div>
				</div> 
							...
							<div class="fileupload fileupload-new" data-provides="fileupload">
								...
								<div>
									<span class="btn btn-default btn-file"> 
										...
										上传图片 <input type="file" class="default" name="f1" id="f1" />
									</span> 
							...
							<div class="fileupload fileupload-new" data-provides="fileupload">
								...
								<div>
									<span class="btn btn-default btn-file"> 
										...
										上传图片 <input type="file" class="default" name="f2" id="f2" />
									</span> 
									<a href="#" class="btn btn-danger fileupload-exists" data-dismiss="fileupload">
										<i class="fa fa-trash"></i> 移除图片
									</a>
			...
			<div class="comMargBot clearfix col-sm-8 saveProInfoBtn" style="margin-left:16.6%;float:none;">
				<button class="btn btn-danger" onclick="addAuction()">保存竞拍信息</button>
			</div>
		</div>
	</div>
</div>
...
//保存竞拍信息
    function addAuction(){
    	...
    	$.ajax({
            ...
            contentType:false,
            processData:false,
			data : new FormData($("#addAuction")[0]),
			success : function(data) {
