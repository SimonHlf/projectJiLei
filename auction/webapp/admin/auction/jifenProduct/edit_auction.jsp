				...
				<div class="row">
					...
					<div class="col-sm-9">
						<input class="form-control" id="organization" name="organization"
							placeholder="证书机构名称" value="${api.organization}"  required>
					</div>
				</div> 
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<input class="form-control" id="website" name="website"
							placeholder="证书机构网站" value="${api.website}" required>
					</div>
				</div> 
				<div class="form-group">
					...
					<div class="col-sm-9">
						<input class="form-control" id="certifi" name="certifi"
							placeholder="证书号" value="${api.certifi}" required>
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-sm-9">
						<input class="form-control" id="origin" name="origin"
							placeholder="产地" value="${api.origin}" required>
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-sm-9">
						<input class="form-control" id="weight" name="weight"
							placeholder="重量" value="${api.weight}" required>
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-sm-9">
						<input class="form-control" id="size" name="size"
							placeholder="尺寸" value="${api.size}" required>
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-sm-9">
						<textarea class="form-control" id="describes" name="describes"
							placeholder="宝贝描述" required onblur="panduan()">${api.describes}</textarea>
					</div>
				</div> 
