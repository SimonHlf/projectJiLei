...
<div class="btn-group">
    <button type="button" onclick="addYouLeProduct()" class="btn btn-info"><i class="fa fa-plus"></i> 添加</button>
    ...
    <button type="button" onclick="setSubmit(1,'','')" class="btn btn-info"><i class="fa fa-pencil"></i> 提交审核</button>
...
<div class="widget">
    <div class="widget-header bordered-bottom bordered-themeprimary">
        ...
        <span class="widget-caption themeprimary">优乐购商品列表</span>
    </div>
                        ...
                        <tr>
                           ...
                           <td>
	                           <c:if test="${n.status==1}">
	                            ...
	                            <c:if test="${n.status==0}">
	                            <button type="button" onclick="up(${n.id},${n.verify},'','')"
