	...
	<div class="widget-body">
		<div id="horizontal-form">
			<form class="form-horizontal" id="editProductDetailsForm">
				...
				<div class="row">
					...
					<div class="comMargBot clearfix">
						...
						<div class="col-sm-6">
							<input class="form-control" id="name" name="name"
								placeholder="商品名" value="${product.name}" onblur="checkNameNum()" required>
					...
					<div class="comMargBot clearfix">
						...
						<div class="col-sm-6">
							<input class="form-control" id="marketprice" name="marketprice"
								placeholder="市场价" type="number" value="${product.marketprice}" required>
					...
					<div class="comMargBot clearfix">
						...
						<div class="col-sm-6">
							<input class="form-control" id="price" name="price"
								placeholder="现价" type="number" value="${product.price}"  required>
					...
					<div class="comMargBot clearfix">
						...
						<div class="col-sm-6">
							<input class="form-control" id="costprice" name="costprice"
								placeholder="成本价" type="number" value="${product.costprice}" required>
							<span style="color:#2dc3e8">单位：元</span>
						</div>
					</div>
					<div class="comMargBot clearfix">
					...
					<div class="comMargBot clearfix">
						...
						<div class="col-sm-6">
							<input class="form-control" id="keywords" name="keywords"
								placeholder="用户搜索关键字" value="${product.keywords}" required>
						</div>
					</div>
					...
					<div class="comMargBot clearfix">
						...
						<div class="col-sm-6">
							<input class="form-control" id="unit" name="unit"
								placeholder="单位" value="${product.unit}" required>
					...
					<div class="comMargBot clearfix">
						...
						<div class="col-sm-6">
							<input class="form-control" id="weight" name="weight"
								placeholder="重量" value="${product.weight}" type="number" required>
					...
					<div class="comMargBot clearfix">
						...
						<div class="col-sm-6">
							<input class="form-control" id="trans" name="trans"
								placeholder="运费" value="${product.trans}" type="number" required>
							<span style="color:#2dc3e8">单位：元</span>
						</div>
					</div>
					...
					<div class="comMargBot clearfix">
						...
						<div class="col-sm-2">
							<input class="form-control" type="date" id="markettime" name="markettime"
								placeholder="上市时间" value="${product.markettime}" required>
						</div>
					</div>
					<div class="comMargBot clearfix">
					...
					<div class="comMargBot clearfix">
						...
						<div class="col-sm-6">
							<input class="form-control" id="gold" name="gold"
								placeholder="兑换金币值" value="${product.gold}" type="number" type="number" required>
					...
					<div class="comMargBot clearfix">
						...
						<div class="col-sm-6">
							<input class="form-control" id="attr0" name="attr0"
								placeholder="购买获得积分值" value="${product.attr0}" type="number" required>
					...
					<div class="comMargBot clearfix">
						...
						<div class="col-sm-6">
							<textarea class="form-control" id="briefly" name="briefly" onblur="panduan()" required>${product.briefly}</textarea>
						...
						<div class="comMargBot clearfix">
							...
							<div class="col-sm-6">
								<input class="form-control" id="attr2" name="attr2"
									placeholder="库存" value="${product.attr2}" type="number" required>
			...
			<div class="comMargBot clearfix saveProInfoBtn">
				<button class="btn btn-danger" onclick="editProductDetails()">保存商品信息</button>
			</div>
		</div>
	</div>
</div>
