				...
				<div class="row">
					...
					<div class="comMargBot clearfix">
						...
						<div class="col-sm-6">
							...
							<span style="color:#2dc3e8">单位：积分；市场价应高于下方商品规格中的最高价；</span>
						</div>
					</div>
					...
					<div class="comMargBot clearfix">
						...
						<div class="upLoadImgDiv col-sm-5">
							...
							<div class="tipInfoTxt left1">
								...
								<p>a.&nbsp;尺寸<span style="color:red;">250*290px</span></p>
					...
					<div class="comMargBot clearfix">
						...
						<div class="col-sm-6">
							<input class="form-control" id="weight" name="weight"
								placeholder="重量" value="${product.weight}" disabled>
					...
					<div class="comMargBot clearfix">
						...
						<div class="col-sm-6">
							<input class="form-control" id="trans" name="trans"
								placeholder="运费" value="${product.trans}" disabled>
							<span style="color:#2dc3e8">单位：积分</span>
						</div>
					</div>
					...
					<!-- 单品    选择单品时   填写库存input框显示
					
					非单品  选择非单品时  下面的属性选择显示 -->
								...
								<tbody id="pro_attrs">
									<c:forEach var="n" items="${listAttrs}">
										<tr>
											...
											<td>${n.parentPrice}</td>
											<%-- <td>
												<button onclick="editProductAttr('${n.id}','${n.productId}')">修改</button>
												<button onclick="delProductAttr('${n.id}','${n.productId}')">删除</button>
											</td> --%>
										<tr>
									</c:forEach>
								</tbody>
