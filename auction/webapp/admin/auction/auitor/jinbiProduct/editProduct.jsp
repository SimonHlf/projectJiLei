					...
					<div class="comMargBot clearfix">
						...
						<div class="col-sm-6">
							<input class="form-control" id="weight" name="weight"
								placeholder="重量" type="number" value="${product.weight}" disabled>
					...
					<div class="comMargBot clearfix">
						...
						<div class="col-sm-6">
							<input class="form-control" id="trans" name="trans"
								placeholder="运费" type="number" value="${product.trans}" disabled>
							<span style="color:#2dc3e8">单位：金币</span>
						</div>
					</div>
    ...
    function panduan(){
    	...
    	if(introduction.length!=0){
    		if(introduction.length>500){
    			...
    			$("#content").val(introduction.substring(0,500))
