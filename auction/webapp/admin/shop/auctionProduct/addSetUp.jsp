	...
	<div class="widget-body">
		<div id="horizontal-form">
			<form class="form-horizontal" method="post" id="addAuctionForm">
				<input type="hidden" value="${id }" name="auctionId">
                ...
                <div class="form-group">
					...
					<div class="col-sm-9">
						<input class="form-control" name="startTime" id="startTime" onclick="WdatePicker({skin:'whyGreen',dateFmt:'yyyy-MM-dd HH:mm',minDate:'${start }'})" style="z-index:999;" placeholder="竞拍开始时间" required>
					</div>
				</div>
				...
				<div class="widget-buttons">
                		<button type="button" onclick="addProductDetails(${id})" class="btn btn-info btn-ok">保存拍卖设置信息</button>
            	</div>
			</form>
		</div>
	</div>
