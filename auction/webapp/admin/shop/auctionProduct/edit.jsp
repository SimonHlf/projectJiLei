	...
	<div class="widget-body">
		<div id="horizontal-form">
			...
			<div class="form-group">
					...
					<div class="col-sm-9">
						<input class="form-control" maxlength="100" id="name" name="name"
							placeholder="商品名" value="<c:out value='${productInfo.name}'/>" required>
					</div>
				</div>
				<div class="form-group">
					...
					<div class="fileupload fileupload-new" data-provides="fileupload">
							<div class="fileupload-new thumbnail"
								style="width: 200px; height: 150px;">
									<c:if test="${productInfo.images=='' || productInfo.images==null}">
										<img
				...
				<div class="form-group">
					...
					<div class="fileupload fileupload-new" data-provides="fileupload">
							<div class="fileupload-new thumbnail"
								style="width: 200px; height: 150px;">
									<c:if test="${info.certificateSide==null || info.certificateSide=='' }">
										<img
											src="http://www.placehold.it/200x150/EFEFEF/AAAAAA&amp;text=no+image"
											alt="" />
									</c:if>
				...
				<div class="form-group">
					...
					<!-- <input type="button" onclick="%%%%()" value="创建Input"/> -->
						<input class="form-control" id="origin" maxlength="100" name="origin"
							placeholder="产地" value="${info.origin }" required>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<!-- <input type="button" onclick="%%%%()" value="创建Input"/> -->
						<input class="form-control" id="weight" maxlength="50" name="weight"
							placeholder="重量" value="${info.weight }" required>
					</div>
				</div> 
				...
				<div class="form-group">
					...
					<!-- <input type="button" onclick="%%%%()" value="创建Input"/> -->
						<input class="form-control" id="size" maxlength="100" name="size"
							placeholder="尺寸" value="${info.size }" required>
					</div>
				</div>  
				<div class="form-group">
					...
					<div class="col-sm-9">
					<!-- <input type="button" onclick="%%%%()" value="创建Input"/> -->
						<input class="form-control"  maxlength="100" id="organization" name="organization"
							placeholder="证书机构名称" value="${info.organization }" required>
					</div>
				</div> 
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
					<!-- <input type="button" onclick="%%%%()" value="创建Input"/> -->
						<input class="form-control" id="website" onblur="checkXS(this.value)" name="website"  maxlength="100"
							placeholder="证书机构网站" value="${info.website }" required>
					</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
					<!-- <input type="button" onclick="%%%%()" value="创建Input"/> -->
						<input class="form-control" id="describes" name="describes"  maxlength="120"
							placeholder="宝贝描述" value="${info.describes }" required>
					</div>
				</div> 
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
					<!-- <input type="button" onclick="%%%%()" value="创建Input"/> -->
						<input class="form-control" id="certifi" name="certifi"  maxlength="100"
							placeholder="证书号" value="${info.certifi }" required>
					</div>
				</div> 
		  		...
		  		<%-- <div class="form-group">
					...
					<div class="col-sm-9">
					<!-- <input type="button" onclick="%%%%()" value="创建Input"/> -->
						<input class="form-control" id="userName" name="userName"  maxlength="100"
							placeholder="上传人" value="${productInfo.userName }" required>
					</div>
				</div>   --%>
				<input type="hidden" id="thisStatus" name="thisStatus" value="2">
				<input type="hidden" id="id" name="id" value="${productInfo.id }">
				<input type="hidden" id="id" name="temporaryId" value="${info.id }">
				<input type="hidden" id="images" name="images" value="${productInfo.images }">
				<input type="hidden" id="certificate" name="certificate" value="${info.certificate }">
				<input type="hidden" id="certificateSide" name="certificateSide" value="${info.certificateSide }">
				<input type="hidden" id="categoryId" name="categoryId" value="${info.categoryId }">
				<%-- <div class="form-group">
					<label class="col-sm-2 control-label no-padding-right">起拍价</label>
					<div class="col-sm-9">
						<input class="form-control" id="startPrice" maxlength="8" name="startPrice" onkeyup="clearNoNum(this)"
							placeholder="起拍价" value="${productInfo.startPrice }" required>
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<input class="form-control" id="hightPrice" maxlength="8" name="hightPrice" onkeyup="clearNoNum(this)"
							placeholder="最高价" value="${productInfo.hightPrice }" required>
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<input class="form-control" id="ladder" value="${productInfo.ladder }"  maxlength="8" name="ladder"  onkeyup="clearNoNum(this)"
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<input class="form-control" id="bond" value="${productInfo.bond }" name="bond" maxlength="8"  onkeyup="clearNoNum(this)"
                ...
                <div class="form-group">
					...
					<div class="col-sm-9">
						...
						<input class="form-control" name="startTime" value="${productInfo.startTime }" id="startTime" onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm'})" style="z-index:999;" placeholder="竞拍开始时间" required>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<input class="form-control" id="endTime" value="${productInfo.endTime }" name="endTime"
