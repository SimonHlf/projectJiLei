		...
		<div id="horizontal-form">
			<form class="form-horizontal" method="post" id="addNewsForm">
				<div class="form-group">
					...
					<div class="col-sm-9">
						<input class="form-control" disabled="disabled" id="subject" value="${auction.subject }" name="subject"
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						...
						<textarea readonly="readonly" disabled="disabled" id="answer" name="answer">${auction.answer }</textarea>
					</div>
				</div>
			</form>
		</div>
