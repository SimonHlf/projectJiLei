		...
		<div id="horizontal-form">
			...
			<input type="hidden" name="id" value="${servicecharge.id}">
				<div class="form-group">
					...
					<div class="col-sm-9">
						<input class="form-control" id="rate" name="rate" value="${servicecharge.rate}" placeholder="金额"
							required>
					</div>
				</div>
...
function updateWithdrawSet(){
	...
	$.ajax({
		method : 'post',
		url : 'shop/servicecharge/updateWithdrawSet.htm',
		async: false, 
        cache: false,  
        contentType:false,
        processData:false,
		...
		success : function(data) {
			alert("更新成功");
			ajaxLoad('shop/servicecharge/toAddWithdrawSet.htm','提现最小金额设置');
		}
	})
