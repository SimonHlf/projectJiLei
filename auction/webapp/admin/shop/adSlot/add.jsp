				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<input class="form-control" id="imgName" name="imgName"
							placeholder="图片名" required>
					</div>
				</div>
				<div class="form-group">
		                  <label class="col-sm-2 control-label no-padding-right">图片显示位置</label>
		                  <div class="col-sm-9">
		                      <v:items type="position" id="position" name="position" />
		                  </div>
		         </div>
				<div class="form-group">
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<input class="form-control" id="sort" name="sort"
							placeholder="图片顺序" required>
					</div>
				</div>
				<div class="widget-buttons">
                	<button type="button" onclick="yes()" class="btn btn-info btn-ok">保存</button>
