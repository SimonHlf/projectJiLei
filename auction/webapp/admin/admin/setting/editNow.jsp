				 ...
				 <div class="form-group">
					...
					<div class="fileupload fileupload-new" data-provides="fileupload">
							<div class="fileupload-new thumbnail"
								...
								<c:if test="${setting.attr0==null || setting.attr0=='' }">
									<img
							...
							<div>
								<span class="btn btn-default btn-file"> <span
									...
									<span class="fileupload-exists"><i class="fa fa-undo"></i>
										替换</span> 上传图片 <input  accept="image/gif,image/bmp,image/jpeg,image/jpg,image/png,image/svg" type="file" class="default"
 ...
 --%>
 				...
 				<div class="form-group">
					...
					<div class="fileupload fileupload-new" data-provides="fileupload">
							<div class="fileupload-new thumbnail"
								style="width: 200px; height: 150px;">
								<c:if test="${setting.attr1==null || setting.attr1=='' }">
									<img
										src="http://www.placehold.it/200x150/EFEFEF/AAAAAA&amp;text=no+image"
										alt="" />
								</c:if>
