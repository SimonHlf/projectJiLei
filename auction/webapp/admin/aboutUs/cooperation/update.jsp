            ...
            <form class="form-horizontal" method="post" id="addItemForm">
                ...
                <div >
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input class="form-control" id="name" maxlength="100" name="name" value="${company.name }" placeholder="名称" required>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-2 control-label no-padding-right">链接</label>
                        <div class="col-sm-9">
                            <input class="form-control" id="url" maxlength="100" name="url" value="${company.url }" placeholder="链接" required>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input class="form-control" id="describes" maxlength="100" name="describes" value="${company.describes }" placeholder="描述">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-2 control-label no-padding-right">备注</label>
                        <div class="col-sm-9">
                            <input class="form-control" id="remark" maxlength="100" name="remark" value="${company.remark }" placeholder="备注">
                        </div>
                    </div>
