...
<body>
	<header class="aui-bar aui-bar-nav headerNav">
        ...
        <div class="aui-title">选择充值方式</div>
    </header>
	<div class="aui-content">
		<div class="conHead">
			<p>您好：${frontUser.nickName }</p>
			<p>您的余额：${frontUser.balance }元</p>
                ...
                <div class="aui-media-list-item-inner">
                    ...
                    <div class="aui-list-item-inner aui-list-item-arrow">
                        ...
                        <div class="aui-list-item-text">
                            <div class="aui-list-item-title aui-font-size-14">支付宝快捷支付</div>
                        </div>
                        <div class="aui-list-item-text">
                            安全快捷，无手续费
                        </div>
            ...
            <li class="aui-list-item aui-list-item-middle">
                <div class="aui-media-list-item-inner">
                    ...
                    <div class="aui-list-item-inner aui-list-item-arrow">
                        ...
                        <div class="aui-list-item-text">
                            <div class="aui-list-item-title aui-font-size-14">微信快捷支付</div>
                        </div>
                        <div class="aui-list-item-text">
                            安全快捷，无手续费
                        </div>
            ...
            <li class="aui-list-item aui-list-item-middle">
                <div class="aui-media-list-item-inner">
                    ...
                    <div class="aui-list-item-inner aui-list-item-arrow">
                        ...
                        <div class="aui-list-item-text">
                            <div class="aui-list-item-title aui-font-size-14">银行卡在线支付</div>
                        </div>
                        <div class="aui-list-item-text">
                            安全快捷，无手续费
                        </div>
	...
	<script type="text/javascript">
		...
		$(".aui-list-item-inner input").each(function(){
			$(this).click(function(){
				...
				window.location.href = "chargeDetail.htm?id="+$.trim($("#userId").val())+"&chargeType="+chargeType;
			});
		});
	</script>
</body>
