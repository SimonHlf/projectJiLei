...
<body>
	...
	<div class="aui-title">修改绑定支付宝</div>
	</header>
	<!-- mainCon -->
	<%-- <c:choose>
	...
	<%-- <c:forEach items="${list}" var="credit"> --%><!-- varStatus="i" begin="0" end="0" step="1" -->
		<ul>
			...
			<li>
				...
				<div class="inpDiv">
					<input id="personNameInp" onblur="checkNameNum()" type="text" placeholder="请输入真实姓名">
				</div>
			</li>
			<li>
				<div class="txtDiv">
				...
				<div class="inpDiv">
					<input id="bankNumInp" onblur="checkBankNum()" type="text" placeholder="请输入支付宝账号">
				</div>
			</li>
			<%-- <li>
				<div class="txtDiv">
