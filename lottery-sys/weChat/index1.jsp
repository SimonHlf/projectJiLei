...
<script
	src="${pageContext.request.contextPath }/weChat/js/jweixin-1.2.0.js"></script>
<script
	src="${pageContext.request.contextPath }/weChat/js/jquery.min.js"></script>
						...
						<div class="aui-grid">
							<div class="aui-row aui-row-img-wt">
								<div class="aui-col-xs-3">
									<a href="nearby_.htm?type=1"> <i class="aui-iconfont "><img
											src="image/icon/icon-1.png" alt=""></i>
										<div class="aui-grid-label">${oneType }</div></a>
								</div>
								<div class="aui-col-xs-3">
									<a href="nearby_.htm?type=2"> <i class="aui-iconfont "><img
											src="image/icon/icon-2.png" alt=""></i>
										<div class="aui-grid-label">${twoType }</div></a>
								</div>
								<div class="aui-col-xs-3">
									<a href="nearby_.htm?type=3"> <i class="aui-iconfont "><img
											src="image/icon/icon-3.png" alt=""></i>
										<div class="aui-grid-label">${threeType }</div></a>
								</div>
								<div class="aui-col-xs-3">
									<a href="nearby_.htm?type=4"> <i class="aui-iconfont "><img
											src="image/icon/icon-4.png" alt=""></i>
										<div class="aui-grid-label">${fourType }</div></a>
								</div>
								<div class="aui-col-xs-3">
									<a href="nearby_.htm?type=5"> <i class="aui-iconfont "><img
											src="image/icon/icon-1.png" alt=""></i>
										<div class="aui-grid-label">${fiveType }</div></a>
								</div>
								<div class="aui-col-xs-3">
									<a href="nearby_.htm?type=6"> <i class="aui-iconfont "><img
											src="image/icon/icon-2.png" alt=""></i>
										<div class="aui-grid-label">${sixType }</div></a>
								</div>
								<div class="aui-col-xs-3">
									<a href="nearby_.htm?type=7"> <i class="aui-iconfont "><img
											src="image/icon/icon-1.png" alt=""></i>
										<div class="aui-grid-label">${sevenType }</div></a>
								</div>
								<div class="aui-col-xs-3">
									<a href="nearby_.htm?type=8"> <i class="aui-iconfont "><img
											src="image/icon/icon-2.png" alt=""></i>
