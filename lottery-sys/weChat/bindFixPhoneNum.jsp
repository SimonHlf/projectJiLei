    ...
    <div class="comInpBox">
    	<ul>
    		<li>
                ...
                <div class="inpDiv">
                    <input id="phoneInp" onblur="checkBile()" value="${frontUser.cellPhone }" type="number" placeholder="请输入手机号码">
                </div>
            </li>
             <li>
                <div class="txtDiv">
            ...
            <li>
                ...
                <div class="inpDiv">
                    <input id="newphoneInp" onblur="checkBile()" type="number" placeholder="请输入新手机号码">
                </div>
            </li>
           <!--  <li>
                <div class="txtDiv">
	...
	<script type="text/javascript">
	  ...
	  function sendPhoneCode(){
		...
		function saveNewPassword(){
			var phoneInp = $("#phoneInp").val();
			var newphoneInp = $("#newphoneInp").val();
			/* var id = $("#userId").val(); */
			...
			if(phoneInp == ""){
				...
				$.ajax({
				method:'post',
				url:'updatePhoneNum.htm',
				data:{
  				  /* id:id, */
  				  newPhone:phoneInp,
  				  newbinPhone:newphoneInp,
  				  valide:valide
  			    },				
