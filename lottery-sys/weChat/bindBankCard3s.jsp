...
<body>
	...
	<div class="aui-title">修改绑定微信</div>
	</header>
	<!-- mainCon -->
	<%-- <c:choose>
	...
	<%-- <c:forEach items="${list}" var="credit"> --%><!-- varStatus="i" begin="0" end="0" step="1" -->
		<ul>
			...
			<li>
				...
				<div class="inpDiv">
					<input id="personNameInp" type="text" placeholder="请输入微信昵称"><!-- onblur="checkNameNum()" -->
				</div>
			</li>
			<li>
				<div class="txtDiv">
				...
				<div class="inpDiv">
					<input id="bankNumInp" onblur="checkBankNum()" type="text" placeholder="请输入微信号">
				</div>
			</li>
			<%-- <li>
				<div class="txtDiv">
	...
	function checkNameNum(){
		...
		if(userId != null && userId != ""){
			if(!reg.test(userId)){
				layer.tips("请输入正确的昵称!!", "#personNameInp", {tips: [2, "#E34127"],time: 1000});
				falg = false;
			}
		}
		return falg;
