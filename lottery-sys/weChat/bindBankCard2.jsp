...
<body>
	...
	<%-- <c:forEach items="${list}" var="credit"> --%><!-- varStatus="i" begin="0" end="0" step="1" -->
		<ul>
			...
			<li>
				<div class="txtDiv">真实姓名：</div>
				<div class="inpDiv">
					<input id="personNameInp" value="${frontUser.realName }" onblur="checkNameNum()" type="text" readonly="readonly">
				</div>
			</li>
			<li>
				<div class="txtDiv">
				...
				<div class="inpDiv">
					<input id="bankNumInp" value="${frontUser.zfCode }" onblur="checkBankNum()" type="text" readonly="readonly">
				</div>
			</li>
			<%-- <li>
				<div class="txtDiv">
	...
	<script type="text/javascript">
		...
		function saveBank(){
			...
			location.href = "updatebindZfb.htm";
		}
	</script>
	<script type="text/javascript">
	function checkBankNum(){
		...
		if(userId != null && userId != ""){
			if(!(reg1.test(userId) || reg2.test(userId))){
				layer.tips("请输入正确的支付宝号", "#bankNumInp", {tips: [2, "#E34127"],time: 1000});
				falg = false;
			}
		}
		return falg;
