...
<body>
	<div class="aui-bar aui-bar-nav headerNav">
        ...
        <div class="aui-title">我的佣金</div>
    </div>
    <!-- mainCon -->
    <form action="${pageContext.request.contextPath }/personal/commission.htm" method="post" id="forms">
	    <div class="comInpBox">
	    	<ul>
	    		<li>
	                <div class="txtDiv">
    		...
    		<div class="scroller">
    			<ul id="zbjl">
    				<c:forEach items="${list }" var="list">
	    				<li>
		           		 	  <p style="width: 75%">${list.creatTime }</p>
	...
	<script type="text/javascript">
		...
		function pullUpAction() {
			...
			setTimeout(
					function() {
						$.ajax({
						url:'${pageContext.request.contextPath }/personal/commission1.htm?page='+page,
						type : 'get',
						data:{
				            	'startDate':stVal,
				            	'endDate':endVal
		...
		function searchRecord(){
			...
			if(stVal == ""){
				...
				$("#zbjl").html("");
				 $.ajax({
					method:'post',
		            url:'${pageContext.request.contextPath }/personal/commission1.htm',
		            data:{
		            	'startDate':stVal,
		            	'endDate':endVal
		            },
        	...
        	if(result.length != 0){
        		 ...
        		 var tli="";
	           	 $.each(result, function (n, value) {
	           		 ...
	           		 str+="<li>"+
	           		 	  "<p style='width: 75%'>"+value.creatTime+"</p>"+
