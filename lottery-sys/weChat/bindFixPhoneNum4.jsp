...
<body>
    ...
    <div class="comInpBox">
    	...
    	<a href="javascript:void(0)" tapmode onclick="saveNewPassword()" class="aui-btn aui-btn-block comAuiBtn">确定</a>
    </div>
	<!-- footer -->
			...
			if(phoneInp == ""){
				...
				success:function(data){
					...
					if(data.result=='success'){
						...
						location.href = "setLoginName.htm";   
					});
